...
%state IN_COMMENT, IN_JAVA_DOC_COMMENT, IN_INQUISITION_TAG, IN_INQUISITION_INPUT
...
// Inquisition tag start

  "@" { yybegin(IN_INQUISITION_TAG); return INQUISITION_TAG_STYLE; }


// Inquisition input start
   "<"("I"|"i")("N"|"n")("P"|"p")("U"|"u")("T"|"t") { yybegin(IN_INQUISITION_INPUT); return INQUISITION_INPUT_STYLE; }


}

<IN_INQUISITION_INPUT> {
